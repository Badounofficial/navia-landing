...
- Welcome screen with Ozaia introducing herself in her voice.
- Four soft questions: name, age, current chapter (cycle / trying / pregnant / post-partum / just here), one thing she wants Ozaia to know about today.
...
- Ozaia acknowledges the check-in with one warm sentence. No upsell.
- Streaks are not tracked. Missing a day is not flagged.

### 3. Smart diary
- Freeform text entry. Voice-to-text available (on-device).
- Ozaia reads the entry and replies in her voice, both on screen and as audio on tap.
- Replies honor the rules in `system-prompt-v1.md` (mirror first, one question max, safety escalation).
- The user can tell Ozaia "don't reply tonight" and Ozaia simply says "I'm here if you need me" and stays quiet.
...
- Phase-aware Ozaia: her tone and her gentle suggestions shift subtly across cycle phases.
...
- Week-by-week content: one short, non-clinical, human note from Ozaia each week. No stock content scraped from parenting sites.
...
### 6. Ozaia's voice (in-app)
- Single custom feminine voice across the app.
- Audio playback for Ozaia's replies, with a subtle waveform.
...
- Single screen. Sebastien's photo, short bio, why Ozaia exists. No hero, no video, no voice intro.
...
- **No community features.** No feed, no forum, no posts. Ozaia is one-to-one, period.
...
- **No web chat version of Ozaia.** The intimacy requires a phone in your hand.
- **No personalization settings for Ozaia's voice** ("make her more energetic!"). There is one Ozaia, one voice, one character.
- **No ads, ever.**
...
4. **Do they tell other women about Ozaia?** Qualitative, via the "how did you find us?" question at onboarding.
5. **Do they say, in their own words, that Ozaia made them feel less alone?** We read every piece of feedback for the first 500 members, by hand.
...
- **Phase 2 (June - September 2026):** iOS prototype with check-in, diary, cycle module, Ozaia voice. Internal testing with ~20 women across chapters.
...
All dates are targets, not commitments. Ozaia launches when Ozaia is ready, not before.
