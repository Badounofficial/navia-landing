# Notes for Sebastien — ideas surfaced during the competitor scan

*Written April 11, 2026 while Sebastien was away. To review together on his return.*

A short list of thoughts that came up while mapping the competitive landscape. None of these are decisions — they are starting points for conversation.
...
## 3. The private circle with automatic context sharing is probably patentable

I am not a lawyer and neither are you, but "consent-bounded companion-to-companion context sharing via a cycle-duration QR invitation" is specific, novel, and non-obvious. If Peanut, Flo, or Stardust ever copies it after we launch, it will be much harder to push back without documented priority.

Suggestion: before Phase 3 (public launch), have a patent attorney review whether this is worth filing a provisional on. Even a cheap provisional gives us a priority date and twelve months to decide whether to invest in a full application. Given that Sebastien already has a legal reminder in memory for trademark and legal checks before public launch, we should add this to that list.
...
## 5. The launch audience should probably be narrower than "every phase of a woman's life"

The current positioning covers puberty to menopause, which is philosophically beautiful but marketing-wise diffuse. Every successful women's health app I saw in the research started with one specific window and expanded:

- Peanut started with moms, added TTC, added menopause years later.
- Ovia started with fertility, added pregnancy, added parenting, just unified everything in 2026.
...
## 6. We should consider a "public side" and a "private side" to the app

The pitch and brand book are beautiful and intimate, but a new visitor to bynavia.com needs to see proof quickly. Screenshots, testimonials, the moon in action, the feel of the companion. Not everyone will read the full pitch.

Suggestion: the homepage becomes a short, feeling-first experience (the moon, a tagline, the day/night toggle, an invitation to read more). The pitch.html stays exactly as it is, linked from a quiet "Read the full vision" button. And the waitlist form is always visible without requiring the full read.
...
## 8. A thought on the EB-1 narrative

Sebastien's EB-1 and holistic health expertise is a genuine credibility signal for press and investors, even though we decided he stays off the front stage visually. Suggestion: on the bynavia.com "about" page (discreet, in the footer, not the hero), a single paragraph naming Sebastien as the founder and his credentials. Not a photo, not a personality play. Just the factual anchor that says "a real expert built this". Investors and journalists will look for it, and not finding it is a red flag they will note.
